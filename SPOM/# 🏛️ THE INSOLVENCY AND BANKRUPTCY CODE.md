...
- **Meeting (Sec 24):**
    ...
    - RP to convene CoC Meeting every 30 days ( But he can also decide to keep 1 per quarter - So atleast 1 per quarter should be there)
...
- T_Day Defined
    |Action|T_day|
    |--|--|
    |Public Announcement not made within| T+3 |
    |RP Not appointed within| T+30 |
    |Info Memo not issued |92 days of announcement|
    |CIRP not completed|T+180|
